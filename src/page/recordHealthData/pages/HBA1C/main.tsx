...
//                     setIsLoading(false);
//                     setMessageError("");
//                     navigation.replace(SCREENS_NAME.RECORD_HEALTH_DATA.NUMERICAL_RECORD_CHART, { isEditable: false })
//                 } else {
//                     setIsLoading(false);
//                     navigation.replace(SCREENS_NAME.RECORD_HEALTH_DATA.NUMERICAL_RECORD, { isEditable: true })
//                 }
//             } catch (error: any) {
